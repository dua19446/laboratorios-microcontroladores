...
; configuratión word 1
  CONFIG FOSC = XT ; Oscillator Selection bits (INTOSC oscillator: CLKOUT function on ((PORTA) and 07Fh), 6/OSC2/CLKOUT pin, I/O function on ((PORTA) and 07Fh), 7/OSC1/CLKIN)
